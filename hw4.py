...
# People you worked with: Lauren Tahari
...
## Write at least 2 additional tests (not repeats of the above described tests). Make sure to include a descriptive message in these two so we can easily see what you are testing!
    ...
    def test_myTestInstance1(self):
    	...
    	b = 2
    	self.assertEqual(type(a[2]), type(b))
    #This checks that the third item in the tuple is the correct type in the play_war_game function.
   
    def test_myTestInstance2(self):
    	a = Deck()
    	b = "hello world"
    	self.assertEqual(type(a.__str__()), type(b))
    #This checks the __str__ method that it returns the correct type which is a string.
